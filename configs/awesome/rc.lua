...
globalkeys = gears.table.join(
	...
	end, { descrption = "open ranger", group = "Personal launchers" }),
	awful.key({ modkey }, "F11", function()
		awful.spawn(home .. "/.scripts/rofi-wifi-menu/rofi-wifi-menu.sh")
	end, { description = "Rofi wifi menu", group = "Personal launchers" }),
	awful.key({ modkey }, "F10", function()
		awful.spawn(home .. "/.scripts/rofi-bluetooth/rofi-bluetooth")
	end, { description = "Rofi bluetooth menu", group = "Personal launchers" }),
	awful.key({ modkey }, "F12", function()
		awful.spawn("rofi -show p -modi p:rofi-power-menu")
	end, { description = "Rofi power menu", group = "Personal launchers" }), -- need to install "rofi-power-menu" aur
	awful.key({ modkey }, "d", function()
		awful.spawn("rofi -show drun")
	end, { description = "rofi-apps", group = "Personal launchers" }),
	awful.key({ modkey, "Shift" }, "d", function()
		awful.spawn(home .. "/.scripts/rofi-files/rofi-files")
	end, { description = "rofi files", group = "Personal launchers" }),
	awful.key({ modkey }, "s", function()
		awful.spawn(home .. "/.scripts/rofi-search/rofi-search")
	end, { description = "rofi web seach", group = "Personal launchers" }),
	awful.key({ modkey, "Shift" }, "s", function()
		awful.spawn("flameshot gui")
	end, { description = "open flameshot", group = "Personal launchers" }),
